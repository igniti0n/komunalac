...
class PrijavaProblemaParking extends StatefulWidget {
  createState() {
    return PrijavaProblemaParkingState();
  }
}
...
class PrijavaProblemaParkingState extends State<PrijavaProblemaParking> {
                          ...
                          return AlertDialog(
                            ...
                            actions: <Widget>[
                              FlatButton(
                                ...
                                onPressed: () {
                                  var url =
                                      "http://komunalci.eu/crikvenica-api/api/PrijavaNepravilnosti";
                                  ...
                                  Map data = {
                                    ...
                                    "Slika": _image != null
                                        ...
                                        : null,
                                    "Dokument": _document != null
                                        ? base64Encode(
                                            _document.readAsBytesSync())
                                        : null,
                                    "NotifyStatus": "false"
                                  };
