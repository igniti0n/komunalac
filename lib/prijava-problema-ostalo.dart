...
class PrijavaProblemaOstalo extends StatefulWidget {
  createState() {
    return PrijavaProblemaOstaloState();
  }
}
...
class PrijavaProblemaOstaloState extends State<PrijavaProblemaOstalo> {
                  ...
                  //      maxHeight: 768, maxWidth: 1024
                   ...
                   /*  final PermissionHandler _permissionHandler = PermissionHandler();
                    ...
                    if (result[PermissionGroup.storage] == PermissionStatus.granted) {
                        ...
                        var image_temp = Img.decodeImage(document.readAsBytesSync());
                        
                      var resized_img =  Img.copyResize(image_temp,width:800);
                      
                

                        setState(() {
                        _document = File.fromRawPath(resized_img.getBytes());
                      });
                     }*/
                  },
                ),
